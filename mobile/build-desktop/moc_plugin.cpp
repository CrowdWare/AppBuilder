...
QT_MOC_LITERAL(5, 41, 6) // "source"

    },
    "Plugin\0titleChanged\0\0sourceChanged\0"
    "title\0source"
};
...
void Plugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plugin::titleChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Plugin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plugin::sourceChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Plugin::titleChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Plugin::sourceChanged()
{
